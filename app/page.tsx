...
import { CarFront, ChevronRight, Users, BarChart3, Settings, Calendar, FileText, CheckCircle } from "lucide-react"
    ...
    <PageTransition>
      <div className="flex min-h-screen flex-col bg-background">
        ...
        <main className="flex-1">
          {/* Hero Section */}
          <section className="w-full py-20 md:py-32 relative overflow-hidden bg-gradient-to-br from-primary/5 via-primary/10 to-background">
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-background rounded-xl p-6 shadow-sm border border-border/50 hover:shadow-md hover:border-primary/20 transition-all"
                  >
            ...
            <div className="container px-4 md:px-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Become a Vendor</h2>
                  <p className="text-muted-foreground text-lg">
                    List your cars on our platform and start earning. We provide all the tools you need to manage your
                    car rental business.
                  </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Simple registration process with document verification
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-medium">Manage Your Fleet</h3>
                        <p className="text-sm text-muted-foreground">
                          Add, edit, and manage your car listings with ease
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-medium">Track Bookings</h3>
                        <p className="text-sm text-muted-foreground">
                ...
                <div className="relative">
                  <div className="absolute -inset-4 bg-gradient-to-r from-primary/20 to-primary/5 blur-2xl rounded-3xl opacity-50"></div>
                  <div className="relative rounded-xl overflow-hidden shadow-2xl border border-primary/10">
                    <img src="/placeholder.svg?height=600&width=800" alt="Vendor dashboard" className="w-full h-auto" />
                  </div>
                </div>
              </div>
            </div>
